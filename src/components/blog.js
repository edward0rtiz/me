                        ...
                        <div className="row">
                            <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
                                <div className="blog-entry">
                                    <a href="https://medium.com/analytics-vidhya/time-series-forecasting-of-exchange-currency-with-tensor-flow-f475927a68b8" className="blog-img"><img src="images/blog_1.jpeg" className="img-responsive" /></a>
                                    <div className="desc">
                            ...
                            <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInRight">
                                <div className="blog-entry">
                                    <a href="https://medium.com/analytics-vidhya/achieve-bayesian-optimization-for-tuning-hyper-parameters-df1aad6cb49a" className="blog-img"><img src="images/blog_2.png" className="img-responsive" /></a>
                                    <div className="desc">
                            ...
                            <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
                                <div className="blog-entry">
                                    <a href="https://medium.com/analytics-vidhya/understanding-transfer-learning-as-an-methodology-for-efficiency-in-training-cnns-models-1322d316173a" className="blog-img"><img src="images/blog_3.png" className="img-responsive" style={{ width: '40%', height: '120%' }} /></a>
                                    <div className="desc">
